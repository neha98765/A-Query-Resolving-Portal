        ...
        <>
            <div className={`sidebar ${darkmode && 'dark'}`} data-visible="false">
                ...
                <div className="sidebar-content">
                    <Link to={`/questions/${1}`} id={window.location.pathname.includes("/questions/")?"selected-sidemenu":""} onClick={handleSidebarQstn} className={`side-menu  ${darkmode && 'sidebar-subtitle-dark'} `}>
                    ...
                    <Link to="/" onClick={handleSidebar} className={`side-menu user-sidebar ${darkmode && 'sidebar-subtitle-dark'}`}>
                        <div className="side-menu-item">
